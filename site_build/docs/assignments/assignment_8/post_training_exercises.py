...
class Head(nn.Module):
    ...
    def __init__(self, head_size, n_embed, context_length):
        super().__init__()
        # TODO: 定义 key, query, value 三个线性投影（无 bias）
        # TODO: 用 register_buffer 注册 causal mask
        pass
...
class Block(nn.Module):
    ...
    def __init__(self, n_head, n_embed, context_length):
        super().__init__()
        # TODO: 定义 LayerNorm、MultiHeadAttention（用题 1 的 Head）、MLP
        pass
...
def sft_loss(logits, tokens, loss_mask):
    ...
    """
    # TODO: 实现 prompt-masked SFT loss
    pass
...
def reward_loss(r_chosen, r_rejected):
    ...
    """
    # TODO: 实现 Bradley-Terry reward loss
    pass
