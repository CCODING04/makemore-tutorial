...
延伸方向（课程路线图 docs/course_roadmap_v3.md）：Part 10 分布式训练——单卡装不下模型的那天。

---

[← 上一章：推理与服务](06_inference_and_serving.md) | [下一章：LoRA 与分类微调 →](08_lora_and_classification.md) | [Part 8 README](README.md)
