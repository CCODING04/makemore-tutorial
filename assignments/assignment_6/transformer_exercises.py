...
def exercise_1_tokenize(text):
    ...
    """
    # TODO: 实现（删除下面的 pass 与 return None）
    pass
    return None
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size):
        ...
        super().__init__()
        # TODO:
        # 1. self.token_embedding_table = nn.Embedding(vocab_size, vocab_size)
        pass
...
def exercise_3_bigram_model(vocab_size):
    ...
    """
    # TODO: return BigramLanguageModel(vocab_size)
    pass
    return None
...
class SelfAttentionHead(nn.Module):
    ...
    def __init__(self, head_size, n_embd, block_size):
        ...
        # TODO:
        # 1. self.key   = nn.Linear(n_embd, head_size, bias=False)
        # 2. self.query = nn.Linear(n_embd, head_size, bias=False)
        # 3. self.value = nn.Linear(n_embd, head_size, bias=False)
        # 4. self.register_buffer('tril', torch.tril(torch.ones(block_size, block_size)))
...
def exercise_4_head(head_size, n_embd, block_size):
    ...
    """
    # TODO: return SelfAttentionHead(head_size, n_embd, block_size)
    pass
    return None
...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, num_heads, head_size, n_embd, block_size):
        ...
        # 2. self.proj = nn.Linear(head_size * num_heads, n_embd)
        pass
...
class Block(nn.Module):
    ...
    def __init__(self, n_embd, n_head, block_size):
        ...
        # 2. self.sa   = MultiHeadAttention(n_head, head_size, n_embd, block_size)
        # 3. self.ffwd = FeedForward(n_embd)
        # 4. self.ln1  = nn.LayerNorm(n_embd)
        # 5. self.ln2  = nn.LayerNorm(n_embd)
        pass
...
def exercise_5_transformer_block(n_embd, n_head, block_size):
    ...
    """
    # TODO: return Block(n_embd, n_head, block_size)
    pass
    return None
