...
│  │    lora_A: Linear(96, 8)        # 可训练，shape (8, 96)              │   │
│  │    lora_B: Linear(8, 288)       # 可训练，shape (288, 8)             │   │
│  │    scaling: α/r = 16/8 = 2.0    # 缩放因子                           │   │
│  │  )                                                                   │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
│  前向传播:                                                                   │
...
│                                                                             │
│  可训练参数: 8×96 + 288×8 = 768 + 2304 = 3,072                              │
│  原始参数: 288×96 = 27,648                                                  │
│  压缩比: 27,648 / 3,072 = 9 倍                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
|------|------|------------|----------|----------|------|
| 200K 玩具 | LoRA r=8 | 6,144 (3.1%) | ~1GB | <1min | 2/3 正确 |
