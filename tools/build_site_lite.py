...
(function(){
  ...
  document.querySelectorAll('.out-card').forEach(function(card){
    ...
    if(btn)btn.onclick=function(){copyText(card.querySelector('pre').innerText,btn);};
  });
})();
...
.inline-plot{border:1px solid var(--line);border-radius:6px;margin:18px 0;background:var(--card);overflow:hidden}
...
.chunk-viz{border:1px solid var(--line);border-radius:6px;margin:18px 0;background:var(--card);overflow:hidden}
...
.viz-card,.viz-tree{border:1px solid var(--line);border-radius:6px;margin:18px 0;background:var(--card);overflow:hidden}
...
.viz-highway{border:1px solid var(--line);border-radius:6px;margin:18px 0;background:var(--card);overflow:hidden}
